...
def get_by_id_should_retrieve_same_object(member_store, member2):
    member2_retrieved = member_store.get_by_id(member2.member_id)
...
def update_should_modify_object(member_store, member3):
    ...
    print(member_store.get_by_id(member3.member_id))
...
def create_posts(members_instances):
    ...
    post1 = models.Post("Agriculture", "Agriculture is amazing", members_instances[0].member_id)
    post2 = models.Post("Engineering", "I love engineering", members_instances[0].member_id)

    post3 = models.Post("Medicine", "Medicine is great", members_instances[1].member_id)
    post4 = models.Post("Architecture", "Spectacular art", members_instances[1].member_id)
    post5 = models.Post("Astronomy", "Space is awesome", members_instances[1].member_id)

    post6 = models.Post("Geology", "Earth is our friend", members_instances[2].member_id)
    post7 = models.Post("ComputerSci", "Our passion", members_instances[2].member_id)
    post8 = models.Post("Algorithms", "Yeah, more of that", members_instances[2].member_id)
    post9 = models.Post("Operating Systems", "Ewww", members_instances[2].member_id)
